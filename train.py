...
optparser.add_option(
    ...
    type='int', help="Token embedding dimension (this must equal to the embedding dimension in emb if it is given)"
)
optparser.add_option(
